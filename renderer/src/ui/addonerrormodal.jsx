...
class AddonError extends React.Component {
    ...
    renderErrorBody(err) {
        ...
        return <div className="bd-addon-error-body">
            <div className="divider-_0um2u topDivider-3xI-Xr"></div>
        ...
        return <div key={`${err.type}-${this.props.index}`} className={joinClassNames("bd-addon-error", (this.state.expanded) ? "expanded" : "collapsed")}>
            <div className="bd-addon-error-header" onClick={() => {this.toggle();}} >
                ...
                <div className="bd-addon-error-header-inner">
                    <h3 className="bd-addon-error-file secondaryHeader-1sJsuH base-21yXnu size16-rrJ6ag">{err.name}</h3>
                    <div className="bd-addon-error-details detailsWrapper-1hquuf">
                        <svg className="detailsIcon-2NtTO9" aria-hidden="false" width="16" height="16" viewBox="0 0 12 12">
                        ...
                        <div className="colorHeaderSecondary-g5teka size12-oc4dx4">{err.message}</div>
                    </div>
                </div>
...
export default class AddonErrorModal extends React.Component {
    ...
    render() {
        ...
        const tabs = this.getTabs();
        return <>
            <div className="bd-error-modal-header header-1zd7se separator-2lLxgC">
                <h4 className="colorStandard-21JIj7 size14-3fJ-ot h4-1_f8j1 title-3hptVQ defaultColor-2cKwKo marginBottom8-emkd0_">{Strings.Modals.addonErrors}</h4>
            ...
            <div className="bd-error-modal-content content-2hZxGK thin-31rlnD scrollerBase-_bVAAt">
